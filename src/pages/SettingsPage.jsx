...
const SettingsPage = () => {
  return (
    <>
      <Helmet>
        <title>Configurações - Stone ERP</title>
      </Helmet>
          ...
          <main className="flex-1 overflow-y-auto p-6 flex items-center justify-center">
            <Card className="max-w-md w-full border-stone-200 shadow-sm">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-xl text-stone-900">Configurações do Sistema</CardTitle>
                <CardDescription className="text-stone-500">Em Desenvolvimento</CardDescription>
              </CardHeader>
              <CardContent className="text-center pb-8">
                <p className="text-stone-600">
                  Painel administrativo para gestão de usuários, permissões e parâmetros gerais do sistema.
                </p>
              </CardContent>
            </Card>
          </main>
