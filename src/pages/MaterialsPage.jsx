...
const MaterialsPage = () => {
  return (
    <>
      <Helmet>
        <title>Materiais - Stone ERP</title>
      </Helmet>
             ...
             <Card className="max-w-md w-full border-stone-200 shadow-sm">
              <CardHeader className="text-center">
                <div className="mx-auto h-16 w-16 rounded-full bg-stone-100 flex items-center justify-center mb-6">
                  <Layers className="h-8 w-8 text-stone-500" />
                </div>
                <CardTitle className="text-xl text-stone-900">Estoque de Chapas</CardTitle>
                <CardDescription className="text-stone-500">Em Desenvolvimento</CardDescription>
              </CardHeader>
              <CardContent className="text-center pb-8">
                <p className="text-stone-600">
                  Controle de inventário de chapas, blocos e insumos com leitura de QR Code em breve.
                </p>
              </CardContent>
            </Card>
          </main>
